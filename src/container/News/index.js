				...
				<div className='row'>
					...
					<div className='col-sm-4'>
						...
						<div className='blog-item'>
								...
								<div className='popup-gallery'>
									<a href='#'>
										...
										<span className='eye-wrapper2'>
											<i className='icon icon-link eye-icon' />
										</span>
									</a>
								</div>
							</div>
							...
							<div className='blog-item-inner'>
								...
								<a href='#' className='blog-icons'>
									<i className='icon icon-user' /> Paul Smith
								</a>
								<a href='#' className='blog-icons last'>
									<i className='icon icon-tags' /> WordPress
								</a>
								<p>
								...
								<a href='#' className='btn btn-lg btn-small-blue scrool'>
									Read More!
								</a>
							</div>
							{/*end blog-item-inner */}
					...
					<div className='col-sm-4'>
						...
						<div className='blog-item'>
							...
							<div className='blog-item-inner'>
								<h3 className='blog-title'>
									<a href='#'>Solid HTML Form Structure</a>
								</h3>
								<a href='#' className='blog-icons'>
									<i className='icon icon-user' /> By John Doe
								</a>
								<a href='#' className='blog-icons last'>
									<i className='icon icon-tags' /> Marketing
								</a>
								<p>
									Quis autem velis etis reprehender etims quiste voluptate
									velite esse quam nihil etsa illum sedit consequatur quias
					...
					<div className='col-sm-4'>
						...
						<div className='blog-item'>
							...
							<div className='blog-item-inner'>
								<h3 className='blog-title'>
									<a href='#'>New WordPress Theme</a>
								</h3>
								<a href='#' className='blog-icons'>
									<i className='icon icon-user' /> By John Doe
								</a>
								<a href='#' className='blog-icons last'>
									<i className='icon icon-tags' /> Design
								</a>
								<p>
									Quis autem velis etis reprehender etims quiste voluptate
									velite esse quam nihil etsa illum sedit consequatur quias
